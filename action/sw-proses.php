...
echo'<table class="table rounded" id="swdatatable">
    ...
    if($result_absen->num_rows > 0){
      ...
      if($row_absen['status']=='Telat'){
          $status=' <span class="badge badge-primary">'.$row_absen['status'].'</span>';
        }
...
<div class="row">
  ...
  <div class="col-md-3">
    <p>Terlambat : <span class="label badge badge-primary">'.$telat->num_rows.'</span></p>
  </div>
