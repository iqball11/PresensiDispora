            ...
            <div class="avatar-section">
                ...
                echo'<img src="'.$base_url.'sw-content/avatar.jpg" alt="image" class="imaged w100 rounded">';
                    ...
                    <img src="timthumb?src='.$base_url.'sw-content/karyawan/'.$row_user['photo'].'&h=100&w=105" alt="avatar" class="imaged w100 rounded">';}
                        echo'
                    <span class="button">
                        <ion-icon name="camera-outline"></ion-icon>yu
                    </span>
                </a>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <form id="update-profile">
                        ...
                        <hr>
                            <button type="submit" class="btn btn-primary mr-1 btn-lg btn-block btn-profile">Simpan</button>
            ...
            <div class="card">
                <div class="card-body">
                    <form id="update-password">
                        ...
                        <hr>
                        <button type="submit" class="btn btn-primary mr-1 btn-lg btn-block">Simpan</button>
                    </form>
